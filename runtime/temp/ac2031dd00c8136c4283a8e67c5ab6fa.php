<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"D:\phpStudy\PHPTutorial\WWW\site\api-admin\public/../application/admin\view\index\edit.html";i:1611917771;s:18:"public/header.html";i:1611919610;s:18:"public/footer.html";i:1611916210;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
  <meta charset="utf-8" />
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <?php if(is_array($api) || $api instanceof \think\Collection || $api instanceof \think\Paginator): $i = 0; $__LIST__ = $api;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$api): $mod = ($i % 2 );++$i;?>
                      <form action="<?php echo url('index/upedit'); ?>" method="post">
                        <div class="row">
                          <input  style="display:none" type="text" value="<?php echo $api['id']; ?>" name="id" class="form-control">
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="bmd-label-floating">API名称 提示：保持在六个字内</label>
                              <input type="text" value="<?php echo $api['name']; ?>" name="apiname" class="form-control">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="bmd-label-floating">API文档地址 示例：qqimg</label>
                              <input type="text" value="<?php echo $api['doc']; ?>" name="apidoc" class="form-control">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="bmd-label-floating">API请求地址 示例：api/qqimg</label>
                              <input type="text" value="<?php echo $api['url']; ?>" name="apipost" class="form-control">
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                              <label class="bmd-label-floating">API返回数据</label>
                              <input type="text" value="<?php echo $api['request']; ?>" name="apiposts" class="form-control">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-sm-10 checkbox-radios" style="padding-top: 4px;">
                            <label class="bmd-label-floating">API分类 (需要重新勾选分类)</label>
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          ...
                          <div class="form-group">
                            <input type="text" value="<?php echo $api['icon']; ?>" name="apiicon" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-9">
                        <div class="form-group">
                          <label class="bmd-label-floating">查看代码</label>
                          <div class="form-group">
                            <input type="text" value="<?php echo $api['democode']; ?>" name="democode" class="form-control">
                          </div>
                        </div>
                      </div>
                      </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control" name="miaoshu" rows="2"><?php echo $api['miaoshu']; ?></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label class="bmd-label-floating">支持富文本</label>
                                <textarea class="form-control" name="diaoyong" rows="2"><?php echo $api['demo']; ?></textarea>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <div class="form-group"id="test-editor">
                                <textarea type="text" name="type"><?php echo $api['type']; ?></textarea>
                              </div>
                            </div>
                          </div>
                        </div>

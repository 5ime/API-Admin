...
(1, 1, '服务器信息', 'GET', '', 'serverinfo', 'api/serverinfo', '', '', 'dvr', '1640776079', 99985, '{"msg":"ok","host":"www.baidu.com","ip":"180.101.49.11","position":"\\u6c5f\\u82cf\\u7701\\u5bbf\\u8fc1\\u5e02 \\u7535\\u4fe1"}', '<table class="mdui-table"><thead><tr>\n<th>参数名称</th><th>类型</th><th>参数值</th><th>描述</th></tr></thead><tbody>\n<tr><td><code>参数名</code></td>\n<td>可选</td><td>参数值</td>\n<td>填写说明</tr>\n</tbody></table>'),
(2, 1, '网站ICP备案', 'GET', '', 'icp', 'api/icp', '', '', 'desktop_mac', '1640775595', 45681, '{\n  "code": 200,\n  "data": {\n    "name": "北京百度网讯科技有限公司",\n    "nature": "企业",\n    "icp": "京ICP证030173号-1",\n    "sitename": "百度",\n    "index": "baidu.com",\n    "time": "2020-08-05"\n  }\n}', '<table class="mdui-table">\n          <thead>\n            <tr>\n              <th>参数名称</th>\n              <th>类型</th>\n              <th>参数值</th>\n              <th>描述</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr>\n              <td><code>url</code></td>\n              <td>必填</td>\n              <td>url</td>\n              <td>即需要查询的网站</td>\n            </tr>\n\n          </tbody>\n        </table>'),
(3, 1, '抖音无水印', 'GET', '', 'douyin', 'api/douyin', '', '移步：https://lab.5ime.cn/video/douyin 查看', 'fiber_dvr', '1640775461', 45649, '{\n  "code": 200,\n  "title": "大家把最近不开心的事都说出来，然后互相安慰、鼓励一下好吗????来吧~????",\n  "cover": "https://p3-dy.byteimg.com/img/tos-cn-p-0015/d7f8177f0d2a478c908c254a64a6129e~c5_300x400.jpeg?from=2563711402_large",\n  "music": "http://p1-dy.byteimg.com/obj/ies-music/1644934451995661.mp3",\n  "url": "http://v6-dy-y.ixigua.com/b94da13a838bb5e04eb58c340d27670a/5f033685/video/m/2209bd0c137bdfd4cf8abc5b4e7721f001f116386b7e00000f1907e9f8f8/?a=1128&br=1203&bt=401&cr=0&cs=0&dr=0&ds=6&er=&l=2020070621342501000806814200298435&lr=&mime_type=video_mp4&qs=0&rc=M293d3M7eHFpcDMzN2kzM0ApNWZmOzlmOzs8Nzo3M2Q5aGdxL15ucC1gXi1fLS1jLTBzcy0wMmJjNV5eLjJiNV5iNWE6Yw%3D%3D&vl=&vr="\n}', '<table class="mdui-table"><thead><tr>\n<th>参数名称</th><th>类型</th><th>参数值</th><th>描述</th></tr></thead><tbody><tr>\n<td><code>url</code></td>\n<td>必选</td><td>	url</td>\n<td>需要解析的视频地址</td>\n</tr></tbody></table>'),
(4, 3, 'QQ一键加群', 'GET', '', 'qun', 'api/qun', '', '<a href="https://tenapi.cn/qun?qun=484395502" >点击加群 </a>', 'camera', '1640776056', 48978, '{   "code": 200,   "data": {     "uid": 546609030,     "idkey": "a7363b3aa40544bbe4b9f4740cf1ec7b8de014470a76e63bae703c975f2d09b5",     "url": "http://wp.qq.com/wpa/qunwpa?idkey=a7363b3aa40544bbe4b9f4740cf1ec7b8de014470a76e63bae703c975f2d09b5"   } }', '<table class="mdui-table">\n          <thead>\n            <tr>\n              <th>参数名称</th>\n              <th>类型</th>\n              <th>参数值</th>\n              <th>描述</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr>\n              <td><code>qun</code></td>\n              <td>必填</td>\n              <td>qun</td>\n              <td>即需要添加的群号</td>\n            </tr>\n            <tr>\n              <td><code>type</code></td>\n              <td>可选</td>\n              <td>301</td>\n              <td>即直接跳转</td>\n            </tr>\n          </tbody>\n        </table>'),
(5, 3, 'QQ在线状态', 'GET', '', 'qqzx', 'api/qqzx', '', '', 'camera', '1640775989', 123123, '{\n  "code": 200,\n  "msg": "电脑在线"\n}', '<table class="mdui-table"><thead><tr>\n<th>参数名称</th><th>类型</th><th>参数值</th><th>描述</th></tr></thead><tbody>\n<tr><td><code>参数名</code></td>\n<td>可选</td><td>参数值</td>\n<td>填写说明</tr>\n</tbody></table>'),
(6, 3, 'QQ头像获取', 'GET', '', 'qqimg', 'api/qqimg', '', '<img src="https://tenapi.cn/qqimg?qq=123456" >', 'camera', '1640775938', 80897, 'https://q2.qlogo.cn/headimg_dl?bs=123456&dst_uin=123456&dst_uin=123456&;dst_uin=123456&spec=100&url_enc=0&referer=bu_interface&term_type=PC', '<table class="mdui-table">\n          <thead>\n            <tr>\n              <th>参数名称</th>\n              <th>类型</th>\n              <th>参数值</th>\n              <th>描述</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr>\n              <td><code>qq</code></td>\n              <td>必填</td>\n              <td>qq</td>\n              <td>即需要查询的qq </td>\n            </tr>\n          </tbody>\n        </table>'),
(7, 1, '历史上的今天', 'GET', '', 'lishi', 'api/lishi', '', '', 'schedule', '1640775910', 45648, '罗马教皇英诺森三世去世', '<table class="mdui-table">\n          <thead>\n            <tr>\n              <th>参数名称</th>\n              <th>类型</th>\n              <th>参数值</th>\n              <th>描述</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr>\n              <td><code>format</code></td>\n              <td>可选</td>\n              <td>json</td>\n              <td>获取全部历史上的今天</td>\n            </tr>\n\n          </tbody>\n        </table>'),
(8, 1, 'IP签名档', 'GET', '', 'ipinfo', 'api/ipinfo', '', '<img src="https://tenapi.cn/ipinfo" >', 'location_on', '1640775881', 44564, 'https://tenapi.cn/ipinfo', '<table class="mdui-table"><thead><tr>\n<th>参数名称</th><th>类型</th><th>参数值</th><th>描述</th></tr></thead><tbody><tr>\n<td><code>暂无</code></td>\n<td>暂无</td><td>暂无</td>\n<td>暂无</td>\n</tr></tbody></table>'),
(9, 1, 'ICO站标获', 'GET', '', 'ico', 'api/ico', '', '<img src="https://tenapi.cn/ico/?url=www.baidu.com" >', 'desktop_mac', '1640775496', 87897, 'https://tenapi.cn/ico/?url=www.baidu.com', '<table class="mdui-table">\n          <thead>\n            <tr>\n              <th>参数名称</th>\n              <th>类型</th>\n              <th>参数值</th>\n              <th>描述</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr>\n              <td><code>url</code></td>\n              <td>必填</td>\n              <td>url</td>\n              <td>即需要获取ico的网站</td>\n            </tr>\n          </tbody>\n        </table>'),
(10, 1, '随机动漫图', 'GET', '', 'img', 'api/img/acg.php', '', '<img src="https://tenapi.cn/img/acg.php" >', 'dvr', '1640775399', 78979, 'https://tva1.sinaimg.cn/large/0072Vf1pgy1foxk76lzl8j31hc0u0dxk.jpg', '<table class="mdui-table"><thead><tr>\n<th>参数名称</th><th>类型</th><th>参数值</th><th>描述</th></tr></thead><tbody><tr>\n<td><code>json</code></td>\n<td>可选</td><td>json/http/https/img</td>\n<td>即返回内容</td>\n</tr></tbody></table>'),
(11, 1, '网站标题获取', 'GET', '', 'title', 'api/title', '', '', 'desktop_mac', '1640776107', 13215, '{"code":"200","title":"Ten▪Api - Tenapi.cn"}', '<table class="mdui-table"><thead><tr>\n<th>参数名称</th><th>类型</th><th>参数值</th><th>描述</th></tr></thead><tbody>\n<tr><td><code>参数名</code></td>\n<td>可选</td><td>参数值</td>\n<td>填写说明</tr>\n</tbody></table>'),
(12, 1, '爱站权重获取', 'GET', '', 'web', 'api/web', '', '<img src="https://tenapi.cn/web/?url=www.baidu.com" >', 'pets', '1640776134', 89897, 'https://statics.aizhan.com/images/br/10.png', '<table class="mdui-table">\n          <thead>\n            <tr>\n              <th>参数名称</th>\n              <th>类型</th>\n              <th>参数值</th>\n              <th>描述</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr>\n              <td><code>url</code></td>\n              <td>必选</td>\n              <td>url</td>\n              <td>即需要查询权重的网址</td>\n            </tr>\n\n          </tbody>\n          <tbody>\n            <tr>\n              <td><code>json</code></td>\n              <td>可选</td>\n              <td>json</td>\n              <td>输出所有权重</td>\n            </tr>\n\n          </tbody>\n        </table>'),
...
(14, 1, '随机一言', 'GET', '', 'yiyan', 'api/yiyan', '', '<script src="https://tenapi.cn/yiyan/?format=js"></script>', 'border_color', '1640776185', 13, 'document.write(''桑丘，让他们管我叫疯子吧，我还疯得不够，所以得不到他们的赞许。'');', '<table class="mdui-table">\n          <thead>\n            <tr>\n              <th>参数名称</th>\n              <th>类型</th>\n              <th>参数值</th>\n              <th>描述</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr>\n              <td><code>format</code></td>\n              <td>可选</td>\n              <td>js</td>\n              <td>返回document.write的脚本</td>\n            </tr>\n            <tr>\n              <td><code>format</code></td>\n              <td>可选</td>\n              <td>text</td>\n              <td>返回text格式(默认)</td>\n            </tr>\n            <tr>\n              <td><code>format</code></td>\n              <td>可选</td>\n              <td>json</td>\n              <td>返回json格式</td>\n            </tr>\n           \n          </tbody>\n        </table>'),
...
(1, '公益API', 'http://tenapi.cn/', '免费提供API服务', '免费提供API服务', '', 'd3b3b1b968a56124689d1366adeacf8f', '', '', '');

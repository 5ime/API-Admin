<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"D:\phpStudy\PHPTutorial\WWW\site\api-admin\public/../application/admin\view\index\sort.html";i:1611917719;s:18:"public/header.html";i:1611919610;s:18:"public/footer.html";i:1611916210;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
  <meta charset="utf-8" />
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $sort['icon']; ?></td>
                          <td class="td-actions">
                              <button type="button" onclick="window.location.href='<?php echo url('index/edits'); ?>?id=<?php echo $sort['id']; ?>'"  class="btn btn-primary btn-link btn-sm">
                                <i class="material-icons">edit</i>
                              </button>
                              <button type="button" onclick="window.location.href='<?php echo url('index/sortdel'); ?>?id=<?php echo $sort['id']; ?>'" class="btn btn-danger btn-link btn-sm">
